...
<head>
  ...
  <title>Manage you sensors</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Sensor Manager</li>
      </ol>
    </section>
...
%>			
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Your Deployed sensors</h3>
...
<br><br><hr>
               <h2 align="center" class="box-title">Manage your sensors</h2>
               <div class="box box-info">
            <div class="box-header with-border">
            ...
            <!-- /.box-header -->
            <!-- form start -->
             <h3 align="center"> Click Create new to invoke a new sensor <br></h3>
             
            <form class="form-horizontal" action="createnew">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Sensor Name</label>

                  <div class="col-sm-10">
                <input align="left" type="text" class="form-control" id="inputEmail3" name="sensorname" placeholder="Enter Sensor Name">
                  </div>
                </div>
                <div class="form-group">
                  <label for="sourceInput" class="col-sm-2 control-label">Source location</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="sourceInput" onfocus="getPlaces(this.id)" name="source" placeholder="Enter sensors source location">
                  </div>
                </div>               
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-info pull-right" name="createnew">Create New</button>
              </div>
              <!-- /.box-footer -->
            </form>
            <div id="map"></div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDFGOGmf-1DTREZJoP9Si319k1hnUWZXTw&callback=initMap&libraries=places"></script>
<!-- jQuery 2.2.3 -->
